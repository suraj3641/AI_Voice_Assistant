 ...
 recognition.onend = () =>setIsListening(false)
  ...
  const handleVoiceCommand = async (command) =>{
    ...
    if (command.includes("what is your name")) {
      const response =
        "Hello Sir I'm AI, Your voice assistant created by SURAj";
      speakText(response);
      setInformation(response);
      return;
    } else if (command.includes("hello ai")) {
      const response = "Hello Sir I'm AI, How can i help you";
      speakText(response);
      setInformation(response);
      return;
    } else if (command.includes("what is your age")) {
      const response = "Hello Sir I'm AI, I'm 2 year old";
      speakText(response);
      setInformation(response);
      return;
    }
